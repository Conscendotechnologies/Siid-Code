...
<br>
<div align="center">
  <h2>Siid Code Topluluğuna Katılın</h2>
...
<a href="https://marketplace.visualstudio.com/items?itemName=ConscendoTechInc.siid-code" target="_blank"><img src="https://img.shields.io/badge/VS%20Marketplace%27den%20İndir-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="VS Marketplace'den İndir"></a>
<a href="https://marketplace.visualstudio.com/items?itemName=ConscendoTechInc.siid-code&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Değerlendir%20%26%20İnceleme-green?style=for-the-badge" alt="Değerlendir & İnceleme"></a>
</div>

**Siid Code**, editörünüzde çalışan yapay zeka destekli **otonom kodlama aracı**dır. Yapabilecekleri:
...
İster esnek bir kodlama ortağı, ister bir sistem mimarı, isterse QA mühendisi veya ürün yöneticisi gibi uzmanlaşmış roller arıyor olun, Siid Code yazılım geliştirme sürecinizi daha verimli hale getirmenize yardımcı olabilir.
...
1. Siid Code'u Yükleyin
2. Yapay Zeka Sağlayıcınızı Bağlayın
3. İlk Görevinizi Deneyin

## Temel Özellikler

### Çoklu Modlar

Siid Code, özelleştirilmiş modlar ile ihtiyaçlarınıza uyum sağlar:
...
Siid Code, şunları yapabilen güçlü araçlar ile gelir:
...
MCP, sınırsız özel araç eklemenize izin vererek Siid Code'un yeteneklerini genişletir. Harici API'lerle entegre olun, veritabanlarına bağlanın veya özel geliştirme araçları oluşturun - MCP, Siid Code'un işlevselliğini özel ihtiyaçlarınızı karşılamak üzere genişletmek için çerçeve sağlar.

### Özelleştirme

Siid Code'u kendi tarzınıza göre çalıştırın:
...
- **GitHub Issues:** [Sorunları bildirin](https://github.com/Conscendotechnologies/Siid-Code/issues) veya [özellik talep edin](https://github.com/Conscendotechnologies/Siid-Code/discussions/categories/feature-requests?discussions_q=is%3Aopen+category%3A%22Feature+Requests%22+sort%3Atop)
...
4. **Hata ayıklama**:
   VSCode'da `F5` tuşuna basın (veya **Run** → **Start Debugging**) Siid Code yüklenmiş yeni bir oturum açmak için.
...
**Siid Code'un keyfini çıkarın!** İster kısa bir tasmayla tutun ister otonom dolaşmasına izin verin, ne inşa edeceğinizi görmek için sabırsızlanıyoruz. Sorularınız veya özellik fikirleriniz varsa, GitHub.com/Conscendotechnologies/Siid-Code) uğrayın. Mutlu kodlamalar!
