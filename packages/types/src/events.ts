...
export enum RooCodeEventName {
	...
	TaskMaxRequestsReached = "taskMaxRequestsReached",
...
export const rooCodeEventsSchema = z.object({
	...
	[RooCodeEventName.TaskAborted]: z.tuple([z.string(), tokenUsageSchema, toolUsageSchema]),
	[RooCodeEventName.TaskMaxRequestsReached]: z.tuple([z.string(), tokenUsageSchema, toolUsageSchema]),
