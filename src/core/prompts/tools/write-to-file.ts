...
Parameters:
- path: (required) The path of the file to write to (relative to the current workspace directory ${args.cwd}). Can include nested directories that don't exist yet - they will be created automatically.
